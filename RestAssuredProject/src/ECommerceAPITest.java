...
public class ECommerceAPITest {
	...
	public static void main(String[] args) {
		...
		loginRequest.setUserEmail("shadi@gmail.com");
		loginRequest.setUserPassword("Shadi_1986713");
		...
		RequestSpecification reqAddProduct = given().log().all().spec(addProductBaseReq).param("productName", "Laptop")
				...
				.multiPart("productImage", new File("\\Users\\Administrator\\Pictures\\Screenshots\\ss.png"));
		...
		String ResponseDeleteProduct = deleteProdReq.when().delete("https://rahulshettyacademy.com/api/ecom/product/delete-product/{productId}")
		.then().log().all().extract().response().asString();
