...
import ShadiTestProject.PageObjects.LandingPage;
...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("shadi@test.com");
		driver.findElement(By.id("userPassword")).sendKeys("Shadi_1986713");
		...
		a.sendKeys(driver.findElement(By.cssSelector("[placeholder='Select Country']")), "jor").build().perform();
